...
- (void)addTarget:(id)target action:(SEL)action forControlEvents:(MiYiLabelControlEvents)controlEvents{
    @synchronized(self){
        if (controlEvents == MiYiLabelControlEventTap) {
        ...
        }else if (controlEvents == MiYiLabelControlEventLongPressBegan){
        ...
        }else if (controlEvents == MiYiLabelControlEventLongPressEnd){
            if (self.longPressGesture == nil) {
                self.longPressGesture = [[UILongPressGestureRecognizer alloc]initWithTarget:self action:@selector(longPressGesture:)];
                [self addGestureRecognizer:self.longPressGesture];
            }
