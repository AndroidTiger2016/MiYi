...
- (void)addTarget:(id)target action:(SEL)action forControlEvents:(MiYiImageViewControlEvents)controlEvents{
    @synchronized(self){
        if (controlEvents == MiYiImageViewControlEventTap) {
        ...
        }else if (controlEvents == MiYiImageViewControlEventLongPressBegan){
        ...
        }else if (controlEvents == MiYiImageViewControlEventLongPressEnd){
            if (self.longPressGesture == nil) {
                self.longPressGesture = [[UILongPressGestureRecognizer alloc]initWithTarget:self action:@selector(longPressGesture:)];
                [self addGestureRecognizer:self.longPressGesture];
            }
